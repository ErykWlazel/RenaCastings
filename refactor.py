...
customize_treeview(build_treeview(root, 1, 0), build_style(), [('ID', 60), ('article_code', 290), ('machining_line', 350), ('location', 200), ('amount', 200), ('container', 230), ('description', 270), ('date', 150)])
